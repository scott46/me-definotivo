...
?>
  ...
  <header class="main-experience" style="background-image: url(imgs/canal/menu-patagonico.jpg);">
    ...
    <div class="content-main-experience">
        <div class="row row-eq-height">
            <div class="col-md-8">
                <h1>Menú Patagónico</h1>
                <div class="cant-experience d-flex flex-row">
                <i class="bi bi-play-fill"></i><p class="time">Video <span>(1hrs 40min)</span></p>
                </div>
  ...
  <section>
      <div class="container content-experience">
          <div class="row">
          <div class="col"><h2>CONTENIDO DEL CANAL</h2></div>
          <div class="col"><a href="" class="bt-back">VOLVER</a></div></div>
<div class="row mb-5">
    <div class="col">
        <div class="embed-responsive embed-responsive-16by9 border">
            <iframe class="embed-responsive-item" src="video/ME-example.mp4" allowfullscreen></iframe>
          </div>
    </div>
</div>
