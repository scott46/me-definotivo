...
?>
  ...
  <header class="main-experience" style="background-image: url(imgs/experiencia/experiencia-maximo-cabrera-principal.jpg);">
  ...
  <section class="experiencia">
      ...
      <div class="row">
          <div class="col"><h2>INTRODUCCIÓN A LA COCINA SALUDABLE</h2></div>
