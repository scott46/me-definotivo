...
$totalEntregasPendientes = ControladorReservas::ctrMostrarEntregasPendientes(null, null);
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-primary">
    ...
    <div class="inner">
      ...
      <p class="text-uppercase">ventas</p>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-warning">
    ...
    <div class="inner">
      ...
      <h3><?php echo count($totalEntregasPendientes); ?></h3>

      <p class="text-uppercase">Entregas Pendientes</p>
