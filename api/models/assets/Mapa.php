...
Class Mapa extends Base{
	...
	*/
	...
	/** 
	* Obtener la url a una imagen a partir del mapa
	* https://developers.google.com/maps/documentation/static-maps/intro?hl=es-419
	*/
	public function url_foto($ancho, $alto){
		return 'https://maps.googleapis.com/maps/api/staticmap?center='.$this->lat.','.$this->lng.'&zoom=15&size='.$ancho.'x'.$alto.'&maptype=roadmap&markers=color:red%7Clabel:S%7C'.$this->lat.','.$this->lng.'&key='.Config::obtener('google')->google_api_key;
	}
