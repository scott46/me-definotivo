...
function bienvenidaForm ($usuario, $empresa) {
					...
					<tr>
						<td style="text-align: left; width: 100%; width: 295px;" align="center" valign="bottom">
							<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
								<tbody>
									<tr>
										<td class="logo-me"><img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/logo-member-experiences.png" alt="logo-member-experiences"></td>
									</tr>
								</tbody>
							</table>
						</td>
...
<tr><td colspan="3" height="15"></td></tr>
					...
					<tr>
						<td width="20"></td>
						<td>
							<img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/header-bienvenida.jpg" alt="bienvenido a ME emepza a disfrutar el contenido" style="max-width: 100%;">
						</td>
						<td width="20"></td>
					</tr>
					...
					<tr>
						<td width="20"></td>
						<td style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 17px; line-height: 20px;">
							
							<span style="font-size:24px; font-weight: bold;">Bienvenida/o a ME</span><br><br>

							Emepezá a disfrutar del mejor contenido creador por tus creadores favoritos.<br>
							¡NO TE LO PIERDAS!</td>
							<td width="20"></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="20"></td>
						<td>
							<a href="http://www.memberexperiences.com.ar" style="font-family:Arial, Helvetica, sans-serif; text-align: center; height: 40px; width: 260px; display: block; border: 1px solid #000000; text-decoration: none; line-height: 40px; color: #000000; font-weight: bold;">EXPLORAR LAS EXPERIENCIAS</a>
						</td>
						<td width="20"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3">
							<img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/banner-amex.png" alt="Hasta el 30/01 30% off acumulable con promociones vigentes. american express Santander Rio." style="max-width: 100%; display: block;">
						</td>
					</tr>

					<tr>
						<td height="112" colspan="3" style="text-align: center; background-color: #F1F0F0;" align="center" valign="middle">
							<img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/me.png" alt="me">
						</td>
					</tr>
										...
										<tr>
											<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
												<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
													<tbody>
														<tr>
															<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/facebook.png" alt="facebook"></td>
															<td width="5"></td>
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/instagram.png" alt="instagram"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/bienvenido/twitter.png" alt="twitter"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
