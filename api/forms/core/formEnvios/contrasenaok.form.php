...
function contrasenaok ($usuario, $empresa) {
					...
					<tr>
						<td style="text-align: left; width: 100%; width: 295px;" align="center" valign="bottom">
							<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
								<tbody>
									<tr>
										<td class="logo-me"><img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/logo-member-experiences.png" alt="logo-member-experiences"></td>
									</tr>
								</tbody>
							</table>
						</td>
...
<tr><td colspan="3" height="15"></td></tr>
					...
					<tr>
						<td width="20"></td>
						<td height="9" background="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/linea-gradient.jpg">
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" width="100%">
							<tbody>
								<tr>
									<td style="text-align: center;" height="170"><img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/cara-feliz.jpg" alt="cara-feliz"></td>
								</tr>
								<tr>
									<td style="font-family:Arial, Helvetica, sans-serif; text-align: center; color: #616161; font-size: 28px; line-height: 28px;">
										...
										SE HA MODIFICADO<br>CORRECTAMENTE TU CONTRASEÑA
					...
					<tr>
						<td width="20"></td>
						<td valign="middle" height="175" background="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/bg-gradient.jpg" style="font-family:Arial, Helvetica, sans-serif; text-align: center; color: #ffffff; font-size: 18px; line-height: 20px;">
					...
					<tr>
						<td height="112" colspan="3" style="text-align: center; background-color: #F1F0F0;" align="center" valign="middle">
							<img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/me.png" alt="me">
						</td>
					</tr>
										...
										<tr>
											<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
												<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
													<tbody>
														<tr>
															<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/facebook.png" alt="facebook"></td>
															<td width="5"></td>
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/instagram.png" alt="instagram"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="https://www.reinicia.com.ar/me/demo/mailings/modificacion-correcta-contrasena/twitter.png" alt="twitter"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
