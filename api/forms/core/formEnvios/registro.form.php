...
function registroForm ($usuario, $empresa, $token) {

	$destinatarios = array($usuario->email);
	$asunto = 'Estas a punto de registrar tu cuenta';
	$cuerpo = '
<!doctype html>
<html lang="es">
<head>
					...
					<tr>
						<td style="text-align: left; width: 100%; width: 295px;" align="center" valign="bottom">
							<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
								<tbody>
									<tr>
										<td class="logo-me"><img src="http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/logo-member-experiences.png" alt="logo-member-experiences"></td>
									</tr>
								</tbody>
							</table>
						</td>
...
<tr><td colspan="3" height="15"></td></tr>
					...
					<tr>
						<td width="20"></td>
						<td height="9" background="https://www.reinicia.com.ar/me/demo/mailings/verificar-mail/linea-gradient.jpg" style="background: url("http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/linea-gradient.jpg"); background-position: center;">
					...
					<tr>
						...
						<table cellspacing="0" cellpadding="0" width="100%">
							<tbody>
								<tr>
									<td style="text-align: center;" height="170"><img src="https://www.reinicia.com.ar/me/demo/mailings/verificar-mail/manos.jpg" alt="manos"></td>
								</tr>
								<tr>
									<td style="font-family:Arial, Helvetica, sans-serif; text-align: center; color: #000000; font-size: 36px; line-height: 35px;">
										ACTIVÁ TU CUENTA<br><span style="font-weight: bold;">ME</span> HACIENDO CLICK<br>EN ESTE <a href="'.$token.'" style="color: #000000;">LINK</a>
					...
					<tr>
						<td width="20"></td>
						<td align: center valign="middle" height="175" background="https://www.reinicia.com.ar/me/demo/mailings/verificar-mail/bg-gradient.jpg" style="font-family:Arial, Helvetica, sans-serif; text-align: center; color: #ffffff; font-size: 18px; line-height: 20px;">
							Contactate con nosotros para<br><a href="#" style="color: #ffffff;">más información</a>
						</td>
						<td width="20"></td>
					</tr>
					...
					<tr>
						<td height="112" colspan="3" style="text-align: center; background-color: #F1F0F0;" align="center" valign="middle">
							<img src="http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/me.png" alt="me">
						</td>
					</tr>
										...
										<tr>
											<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
												<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
													<tbody>
														<tr>
															<td width="20"><img src="http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/facebook.png" alt="facebook"></td>
															<td width="5"></td>
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/instagram.png" alt="instagram"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
									...
									<tr>
										<td height="35" style="text-align: center; width: 100%; width: 180px;" align="center">
											<table cellspacing="0" cellpadding="0" border="0" style="border-spacing: 0px; border-collapse: collapse; width:100%;" align="center">
												<tbody>
													<tr>
														<td width="20"><img src="http://www.reinicia.com.ar/me/demo/mailings/verificar-mail/twitter.png" alt="twitter"></td>
														<td width="5"></td>
														<td width="140" style="font-family:Arial, Helvetica, sans-serif; text-align: left; color: #000000; font-size: 14px; line-height: 24px;">
	...
	Email::sendEmpresaRegistro($usuario, 'Usuario nuevo registrado');
	return $envio;
