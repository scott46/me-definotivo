...
<html lang="en">
	<head>
		...
		<title>ME | <?=$user_language == 'es' ? 'Próximamente' : 'Coming soon' ?></title>
	</head>
	<body>
		<header>
			<div class="container">
				<div class="row">
				    ...
				    <div class="bg-center">
				      <img src="<?=$user_language == 'es' ? 'imgProx/me-proximamente.png' : 'imgProx/me-proximamente-eng.png' ?>" alt="follow me" class="img-fluid">
				    </div>
