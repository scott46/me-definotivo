...
define('SECCION', 'privacidad');
$section = 'checkout';
$color = 'white';
include_once("inc/header.php");


$preguntasApi = ControladorFaq::ctrMostrarComponentes('politicas');
...
?>
  ...
  <header class="header-terms d-flex justify-content-center align-items-center flex-column bg-terms-3">
    <h1><?= __('privacidad 0') ?></h1>
    <h2><?= __('privacidad 1') ?></h2>
  </header>
